...
public class ParagraphMode extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtParagraph.setText(textData[0]);
        intCurrent=0;
    ...
    public boolean spellCheck(@NonNull String currentWord, int spaceNo){
        ...
        if(textData[spaceNo].equals(currentWord)){
            ...
            txtParagraph.setTextColor(getResources().getColor(R.color.Green));
            txtParagraph.setText(textData[spaceNo]);
            edtTextWriter.setText("");
            flag=true;
            this.rightWord++;
        }
        else{
            txtParagraph.setTextColor(getResources().getColor(R.color.Red));
            flag=false;
            this.wrongWord++;
        }
